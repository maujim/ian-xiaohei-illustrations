...
Generate each image separately. Replace the variables according to the article content; do not combine multiple images into one.
...
Structure type:
{structure type: Workflow / System Slice / Before and After / Character State / Conceptual Metaphor / Method Layers / Map Route / Mini Comic Panels}

Core idea:
{the core idea this image should express}

Composition:
{specific scene: where Xiaohei is, what Xiaohei is doing, what the main objects are, and how information flows}
